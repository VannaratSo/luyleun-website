          ...
          <div className="max-w-6xl mx-auto px-6 py-12">
            <div className="text-center max-w-2xl mx-auto">
              ...
              <p className="text-gray-300 mb-6">
                Get the latest updates on loan offers, financial tips, and exclusive promotions delivered to your inbox.
              </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8">
            ...
            <div className="lg:col-span-2">
              ...
              <p className="text-gray-300 mb-6 text-sm leading-relaxed">
                Cambodia's first fully digital lending platform. We provide fast, secure, and accessible financial solutions to help you achieve your goals.
              </p>
              ...
              <div className="flex space-x-4 mt-6">
                {socialLinks.map((social) => (
                  <Link
                    key={social.name}
                    href={social.href}
                    className="w-10 h-10 bg-white/5 hover:bg-gradient-to-r hover:from-cyan-500 hover:to-blue-600 border border-white/10 hover:border-transparent rounded-lg flex items-center justify-center text-gray-400 hover:text-white transition-all duration-300 transform hover:scale-110 hover:shadow-lg"
                    target="_blank"
