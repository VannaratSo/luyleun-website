...
class App {
  ...
  disposed: boolean;
  road: Road | null;
  leftCarLights: CarLights | null;
  rightCarLights: CarLights | null;
  leftSticks: LightsSticks | null;
...
const Hyperspeed: FC<HyperspeedProps> = ({ effectOptions = {} }) => {
  ...
  const options = useMemo(() => {
    ...
    if (typeof opts.distortion === "string") {
  ...
  useEffect(() => {
    cleanup(); // Clean up any existing app
